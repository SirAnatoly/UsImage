...
import static com.siranatoliy.usimage.ejb.repository.mock.InMemoryDataBase.IMAGES;
...
public class PhotoRepositoryInvocationHandler implements InvocationHandler{
    ...
    private Object findProfilePhotosLatestFirst(Object[] args) {
        ...
        if(profileId.equals(PROFILE.getId())) {
            return IMAGES.stream().skip(offset).limit(limit).collect(Collectors.toList());
        } else {
